...
begin
  ...
  begin
    ...
    begin
      SQLQuery1.SQL.Text := SQLQuery1.SQL.Text +' WHERE INS_TYPE = 0'
    end;
    If rbSJobs.Checked = True Then
    begin
      SQLQuery1.SQL.Text := SQLQuery1.SQL.Text +' WHERE INS_TYPE = 1'
    end;
    If rbSServices.Checked = True Then
    begin
      SQLQuery1.SQL.Text := SQLQuery1.SQL.Text +' WHERE INS_TYPE = 2'
    end;
  end;
  ...
  begin
    SQLQuery1.SQL.Text := ' SELECT * FROM MAIN WHERE DESCRR LIKE '
      +'''%'+editSearchQuery.Text+'%''';
    If rbSGoodies.Checked = True Then
    begin
      SQLQuery1.SQL.Text := SQLQuery1.SQL.Text +' WHERE INS_TYPE = 0'
